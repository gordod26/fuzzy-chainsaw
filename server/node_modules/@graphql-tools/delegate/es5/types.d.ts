...
export declare type DelegationPlanBuilder = (schema: GraphQLSchema, sourceSubschema: Subschema<any, any, any, any>, fieldNodes: ReadonlyArray<FieldNode>, fragments?: Record<string, FragmentDefinitionNode>, variableValues?: Record<string, any>, stitchingInfo?: StitchingInfo, mergedTypeInfo?: MergedTypeInfo, targetSubschemas?: Array<Subschema>) => Array<Map<Subschema, SelectionSetNode>>;
